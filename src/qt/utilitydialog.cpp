...
All the MANO in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MANO, 0.1 MANO, 1 MANO and 10 MANO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.manocoin.org/PrivateSend\">https://www.manocoin.org/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
