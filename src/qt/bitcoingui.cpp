...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MANO Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MANO Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MANO Core help message to get a list with possible MANO Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MANO client") + " " + networkStyle->getTitleAddText();
