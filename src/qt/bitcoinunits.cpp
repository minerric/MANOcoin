...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case mMANO: return QString("mMANO");
            case uMANO: return QString::fromUtf8("μMANO");
    ...
    else
    {
        switch(unit)
        {
            case MANO: return QString("tMANO");
            case mMANO: return QString("mtMANO");
            case uMANO: return QString::fromUtf8("μtMANO");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MANO:  return 100000000;
    case mMANO: return 100000;
    case uMANO: return 100;
    case nodes: return 1;
